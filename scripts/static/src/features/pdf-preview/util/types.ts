...
// NOTE: upstream this is `../../../../../types/compile` (5 levels up, to
// `services/web/types/compile`). Our tree is one level shallower — the path
// is adjusted by one `..` to land at `src/types/compile`.
