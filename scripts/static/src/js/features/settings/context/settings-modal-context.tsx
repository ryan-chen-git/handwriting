...
// Fall back to a render-null placeholder when the optional module is absent
// (always, in our offline build) — React rejects `<undefined />`.
const ReferenceSearchSetting =
  referenceSearchSettingModule?.import.default ?? (() => null)
