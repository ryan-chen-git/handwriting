...
const initialState: ConnectionState = {
  // Offline build: pretend we're permanently connected. Our socket shim is
  // a no-op so the manager will never transition state on real events; keep
  // the loading screen unblocked by starting in OPEN.
